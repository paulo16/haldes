...
<div class="row">
  <div class="col-sm-12">
    <div class="card-box table-responsive">
      <h4 class="header-title m-t-0 m-b-30">Ajouter Un Site (Haldes -Terrils)</h4>
      <div class="row">
        <div class="col-lg-7 col-lg-offset-2">

          <!-- Start add form -->
          <form action="{{route('haldes.store')}}" method="post" data-parsley-validate novalidate>
            @csrf

            <div class="form-group{{ $errors->has('nom') ? ' has-error' : '' }}">
              <label for="nom">Nom*</label>
              <input type="text" name="nom" parsley-trigger="change" required placeholder="Entrer le nom"
                class="form-control" id="nom" value="{{ old('nom') }}">
            ...
            <div class="form-group{{ $errors->has('info_comp') ? ' has-error' : '' }}">
              ...
              <input type="text" name="info_comp" class="form-control" id="info_comp" value="{{ old('info_comp') }}">
