<div class="topbar">
    ...
    <div class="topbar-left">
        <div class="text-center">
            <a href="{{route('ADMIN')}}" class="logo"><span>Haldes</span></a> 
        </div>
    </div>
        ...
        <div class="container">
            <div class="">
                <ul class="nav navbar-nav navbar-right pull-right">
                    ...
                    <li class="">
                        <a>Administration de la plateforme de demande de permis d'exploitation haldes/terrils</a>
                    </li>
                    <li class="hidden-xs">
                    ...
                    <li class="dropdown top-menu-item-xs">
                        ...
                        aria-expanded="true"><img src="{{asset('/assets/backend/images/users/avatar-1.jpg')}}"
