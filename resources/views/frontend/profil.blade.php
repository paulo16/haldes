...
<header class="bg-grad-blue  mt70">
    <div class="container">
        <div class="row mt20 mb30">
            ...
            <div class="col-sm-2">
                <img title="profile image" class="img-circle img-responsive" src="{{ asset('assets/frontend/img/avatar/user.png') }}">
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-sm-9">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="home">
                        <h2>RESPONSABLE / REPRESENTANT</h2>
                        <br>
                        <div class="col-md-6">
                    ...
                    <div class="tab-pane" id="messages">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-7 col-xs-6 ">{{ $personne->nationalite_s }} DH</div>
                            <div class="clearfix"></div>
                            <hr>
                            <!-- another element-->
